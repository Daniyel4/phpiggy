<?php include $this->resolve("paritals/_header.php") ; ?>
        ...
        <div>
          <label class="inline-flex items-center">
            ...
            <?php echo $oldFormData['tos'] ?? false ? 'checked' : ''; ?>
             name="tos" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-offset-0 focus:ring-indigo-200 focus:ring-opacity-50"
              type="checkbox"
            />
...
<?php include $this->resolve("paritals/_footer.php") ; ?>